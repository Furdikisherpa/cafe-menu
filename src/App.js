  ...
  return (
    <div className="App">
      <div>
        ...
        <address>
            <p>
                <svg viewBox="0 -100 500 512" width="20"
                title="map=marke-alt">
                <path d="M172.268 501.67C26.97 291.031 0 269.413 0 192 0 
                ...
                35.817-80 80 35.817 80 80 80z" transform="rotate(-20)" />
                </svg>
            ...
            <a href="4125550100">
                <svg viewBox="-200 50 600 600" width="20" title="phone-alt">
                    <path d="M497.39 361.8l-112-48a24 24 0 0 0-28 6.9l-49.6 60.6A370.66 
                    370.66 0 0 1 130.6 204.11l60.6-49.6a23.94 23.94 0 0 0 6.9-28l-48-112A24.16 
                    24.16 0 0 0 122.6.61l-104 24A24 24 0 0 0 0 48c0 256.5 207.9 464 464 464a24
                    24 0 0 0 23.4-18.6l24-104a24.29 24.29 0 0 0-14.01-27.6z" transform="rotate(25)" />
                </svg>
                412-555-0100
            </a>
        </address>
        ...
        <ul class="boxes">
            ...
            <li class="box">
                <h2>Espresson Drinks</h2>
                <p class="prices"> <span>Small <em>$3</em> </span> <span>Large<em>$5</em></span> </p>
                <dl>
                    <dt>Machiatto</dt>
                    <dd class="description">
                        <p>Espresso and steamed milk, served in a demitasse cup. <span>(Size small Only)</span></p>
                    </dd>
                    <dt>Latte</dt>
                        <dd class="description">
                    ...
                    <dt>Mocha</dt>
                    <dd class="description">
                        <p>Espresso with steamed chocolate milk ad whipped cream. Also availabe with white chocolate milk.</p>
                    </dd>
                    <dt>Americano</dt>
                    <dd class="description">
